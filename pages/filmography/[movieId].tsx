            ...
            <div className="bg-blend-darken bg-black opacity-70 rounded-3xl w-1/2 p-4 pt-2 min-w-[143px] flex flex-col mb-16 items-between">
              ...
              <p className="text-center">
                <Link
                  ...
                  className="font-bold text-blue-500 underline hover:text-[#FCF6ba] transition-colors duration-200"
                >
                  {" "}
              ...
              <p className="text-center">
                <Link
                  ...
                  className="font-bold text-green-500 underline hover:text-[#FCF6ba] transition-colors duration-200"
                >
